...
public class SocketCliente {
    ...
    public void ConectarCliente() {
        ...
        try {
			partida = new Partida(server, frameJugador2, false);
		} catch (IOException e) {
    	...
    	frameJugador2.setTextoTurno(false);
    ...
    public void actualizarMazosJugador2(List<Carta> disponibles, List<Carta> tiradas, int turno) {
    	...
    	frameJugador2.setTextoTurno(partida.esMiTurno());

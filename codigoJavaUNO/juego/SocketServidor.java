...
public class SocketServidor {
    ...
    public void actualizarMazosJugador1(List<Carta> disponibles, List<Carta> tiradas) {
    ...
    public void empezarServidor() {
        ...
        new Thread(() -> {
            try {
                ...
                partida = new Partida(oponente, frameJugador1.getlblPilaDescarte(), frameJugador1.getPanelBaraja());
